...
export default function Login() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-cream">
            ...
            >
                {/* Overlay for better text processing if image is busy, optional */}
                ...
                <div className="hidden md:flex w-1/2 h-full justify-center items-center z-10">
                    <div className="p-10 text-green-dark text-center drop-shadow-lg bg-cream/70 rounded-xl backdrop-blur-sm">
                        ...
                        <p className="mt-4 text-sm uppercase tracking-widest text-green-medium">- Rachel Zoe</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 h-full flex justify-center items-center p-8 z-10">
                    <div className="w-full max-w-md bg-white/70 backdrop-blur-md p-8 rounded-lg shadow-2xl border border-white/50">
                        <h1 className="text-3xl font-bold text-center text-green-dark mb-8">Sign in</h1>
                        ...
                        <form className="space-y-6" onSubmit={handleLogin}>
                            <div>
                                ...
                                <input
                                    ...
                                    ref={emailRef}
                                    className="w-full p-3 bg-white/50 border border-green-light text-green-dark placeholder-green-dark/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-medium focus:border-transparent transition duration-200"
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3 bg-green-dark hover:bg-green-medium text-cream font-semibold rounded-lg transition duration-200 shadow-md"
                            >
                        ...
                        <div className="mt-6 text-center text-sm text-green-dark/80">
                            ...
                            <a href="/register" className="text-green-medium hover:underline font-bold ml-1"> Register now</a>
                        </div>
                    </div>
                </div>
            </div>
